...
class Form_27_01_Tests(unittest.TestCase):
    ...
    def test_all_random(self):
        ...
        f.find_and_write_textbox("BR15 0000 0000 0000 1093 2840", f.XPATH_IBAN_TEXT, By.XPATH, remember_value=False)
        ...
        f.find_and_write_textbox(r"c:\Users\bocek\OneDrive - QCM, s.r.o\codes\python_projects\SUKL_UI_Tests\src\resources\downloads\platby-nahrady-vydaju-zdravotnicke-prostredky_1_2_2022_13_16_57.json", "/html/body/div[1]/div/div[1]/div/form/div[3]/fieldset/div/div/div/div[2]/div[2]/input", By.XPATH, remember_value=False)
        time.sleep(500)
